...
namespace Patchwork.Utility {
	public static class PeVerifyRunner {
		...
		public static string RunPeVerify(AssemblyDefinition targetAssembly, string folderLocation,string switches = DefaultPeVerifySwitches, IEnumerable<long> ignoreErrors = null) {
			string ret;
